...
ku_request_urls = [
    ...
    'http://www.konkuk.ac.kr/do/MessageBoard/ArticleList.do?forum=notice&cat=0000300006' # Ilban
    ]
...
ku_exported_filename_haksa = system_path + 'notice_haksa.kns'
ku_exported_filename_janghak = system_path + 'notice_janghak.kns'
ku_exported_filename_changup = system_path + 'notice_changup.kns'
ku_exported_filename_guukjae = system_path + 'notice_guukjae.kns'
ku_exported_filename_haksaeng = system_path + 'notice_haksaeng.kns'
ku_exported_filename_sanhak = system_path + 'notice_sanhak.kns'
ku_exported_filename_ilban = system_path + 'notice_ilban.kns'
